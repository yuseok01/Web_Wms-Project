package com.a508.wms.productlocation.controller;

import com.a508.wms.productlocation.dto.ProductLocationRequestDto;
import com.a508.wms.productlocation.service.ProductLocationService;
...
public class ProductLocationController {
    ...
    @GetMapping
    public BaseSuccessResponse<?> getProductLocation(
    ...
    @PatchMapping
    public BaseSuccessResponse<?> updateProductLocation(
        @RequestBody ProductLocationRequestDto productLocationRequestDto) {
